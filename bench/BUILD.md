...
| Dynamic | `/address/[address]/anchor-account` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/anchor-program` | 380 kB | 1.40 MB |
| Dynamic | `/address/[address]/attestation` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/attributes` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/blockhashes` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/compression` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/concurrent-merkle-tree` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/domains` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/entries` | 390 kB | 1.40 MB |
...
| Dynamic | `/address/[address]/metadata` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/nftoken-collection-nfts` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/program-multisig` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/rewards` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/security` | 390 kB | 1.41 MB |
| Dynamic | `/address/[address]/slot-hashes` | 390 kB | 1.40 MB |
| Dynamic | `/address/[address]/stake-history` | 390 kB | 1.40 MB |
...
| Dynamic | `/address/[address]/vote-history` | 390 kB | 1.40 MB |
| Dynamic | `/api/anchor` | — | — |
