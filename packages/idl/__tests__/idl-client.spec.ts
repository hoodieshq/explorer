...
// decoding sections group by document flavor (modern Anchor / converted / Codama).
// Runtime flows only — the typed routes are demonstrated in readme-flows.integration.spec.ts.
