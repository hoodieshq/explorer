...
// Real mainnet snapshots (refresh via scripts/fetch-onchain-idls.mjs). NOTE: both legs carry the SAME
// Anchor-format document — PMP is a storage mechanism, not a format; this program never uploaded a
// Codama root (SPL Token's PMP leg is the codama sample, see ./tokenkeg.ts).
