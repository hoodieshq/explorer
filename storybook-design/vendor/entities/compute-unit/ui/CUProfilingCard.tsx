/* eslint-disable @typescript-eslint/consistent-type-assertions, unicorn/no-null -- vendored copy of app/entities/compute-unit/ui/CUProfilingCard.tsx; the upstream path is exempted
...
import type { InstructionCUData } from '@/app/entities/compute-unit/lib/types';
...
export function CUProfilingCard({ instructions, unitsConsumed, headerless = false }: CUProfilingCardProps) {
    ...
    const body = (
        <CardBody ui="dashkit" className="px-3 py-3">
