/* eslint-disable @typescript-eslint/no-explicit-any -- vendored copy of app/components/ProgramLogsCardBody.tsx; the upstream path is exempted
   from these rules by the TODO allowlists in eslint.config.mjs, which only match app/**. */
import { TableCardBody } from '@components/common/TableCardBody';
import { useAnchorProgram } from '@entities/idl';
import { type ParsedMessage, type PublicKey, TransactionInstruction, type VersionedMessage } from '@solana/web3.js';
