/* eslint-disable @typescript-eslint/consistent-type-assertions, @typescript-eslint/no-explicit-any, unicorn/no-null -- vendored copy of app/components/inspector/InstructionsSection.tsx; the upstream path is exempted
...
// Instruction detail cards stay on the app copies — this vendor file only adds the surrounding
// CollapsibleSection, so the relative sibling imports become absolute app imports.
...
import { SystemDetailsCard } from '@/app/components/instruction/system/SystemDetailsCard';
import { TokenDetailsCard } from '@/app/components/instruction/token/TokenDetailsCard';
