/* eslint-disable unicorn/no-null -- vendored copy of app/components/inspector/AddressWithContext.tsx; the upstream path is exempted
   from these rules by the TODO allowlists in eslint.config.mjs, which only match app/**. */
import { Address } from '@components/common/Address';
import { cn } from '@components/shared/utils';
import { type Account, useAccountInfo, useAddressLookupTable, useFetchAccountInfo } from '@providers/accounts';
