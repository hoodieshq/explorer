/* eslint-disable unicorn/no-null -- vendored copy of app/components/inspector/AddressTableLookupsCard.tsx; the upstream path is exempted
    ...
    return (
        <CollapsibleCard title="Address Table Lookup(s)">
            <BaseTable ui="dashkit" variant="card" nowrap>
                <BaseTable.Head>
                    <BaseTable.Row>
                        <BaseTable.HeaderCell className="text-outer-space-300">
                            Address Lookup Table Address
                        </BaseTable.HeaderCell>
                        <BaseTable.HeaderCell className="text-outer-space-300">Table Index</BaseTable.HeaderCell>
                        <BaseTable.HeaderCell className="text-outer-space-300">Resolved Address</BaseTable.HeaderCell>
                        <BaseTable.HeaderCell className="text-outer-space-300">Details</BaseTable.HeaderCell>
                    </BaseTable.Row>
                </BaseTable.Head>
                {lookupRows.length > 0 ? (
