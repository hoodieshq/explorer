...
const alertVariants = cva(['relative', 'rounded-dk', 'border', 'border-solid', 'px-4', 'py-3', 'text-sm'], {
    compoundVariants: [
        ...
        // info + warning match the Security.txt / Verified-Build `InfoCard` panels from H-explorer
        // (pre-storybook): a semi-transparent tinted block (bg 10% / border 25%), light body text,
        // a brighter icon, and anchor tints. Ported verbatim minus the `e-` prefix.
        {
            appearance: 'outlined',
            class: cn(
