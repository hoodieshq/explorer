...
// Vendored copy of app/shared/ui/navigation-tabs/ui/MobileMoreDropdown.tsx that also honours
// `disabledPaths`: an overflowed tab that is disabled renders as a dimmed, non-interactive item
// inside the dropdown instead of a link.
...
import { type NavigationTab } from '../model/types';
