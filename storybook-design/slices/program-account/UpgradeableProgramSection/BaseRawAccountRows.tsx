...
export function BaseRawAccountRows({ account, rawData, isLoading }: BaseRawAccountRowsProps) {
    return (
        <>
            ...
            <KeyValue label="Assigned Program Id" labelWidth={LABEL_WIDTH}>
                <Address pubkey={account.owner} link />
            </KeyValue>
            {account.space !== undefined && (
                <KeyValue label="Allocated Data Size" labelWidth={LABEL_WIDTH}>
            ...
            <KeyValue label="Raw Data" align="end" labelWidth={LABEL_WIDTH}>
