...
/**
 * Left-aligned value primitives for the tab cards' `KeyValue` rows. They mirror the cell
 * renderers the old BaseTable variants used (`common.tsx` / VerifiedBuildCard's RenderEntry)
 * but drop the `text-right` / `alignRight` / `BaseTable.Cell` wrappers so the value sits at
 * the start of the value column — the same left-aligned treatment UpgradeableProgramSection
 * gives its addresses and slots.
 *
