...
function LoadedView({
    ...
    const { message, rawMessage, signatures, compiledInnerInstructions, accountBalances } = transaction;
        ...
        <>
            ...
            <div className="mt-9 flex flex-col space-y-9 lg:mt-12 lg:space-y-12">
                ...
                {/* Renders (with its own `#address-lookups` anchor) only when the message references lookup
                    tables — otherwise it returns null, matching the gated tab above. */}
