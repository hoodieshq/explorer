...
const meta = {
    ...
    decorators: [
        Story => (
            <div>
                <Toaster position="bottom-center" toastOptions={{ duration: 50_000 }} />
                <Story />
            </div>
        ),
    ],
...
const TriggerButton = ({ onClick, children }: { onClick: () => void; children: React.ReactNode }) => (
    <button
        className="e-rounded e-border-0 e-bg-blue-500 e-px-4 e-py-2 e-text-white hover:e-bg-blue-600"
        onClick={onClick}
    >
        {children}
    </button>
