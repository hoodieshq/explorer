...
const inputVariants = cva(
    cn(
        ...
        'e-px-4 e-py-2.5 e-text-xs e-shadow-sm',
        'focus-visible:e-outline-none focus-visible:e-ring-1',
    ...
    ),
    {
        ...
        variants: {
            variant: {
                dark: 'e-border-solid e-border-outer-space-950 e-bg-heavy-metal-900 e-text-neutral-200 placeholder:e-text-neutral-400 focus-visible:e-ring-neutral-300',
                default:
                    'e-border-neutral-200 e-bg-transparent e-text-neutral-200 placeholder:e-text-neutral-300 focus-visible:e-ring-neutral-950',
            },
        },
    }
);
