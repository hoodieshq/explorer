        ...
        <div>
            ...
            <div className={width}>
                <div className={`flex flex-col rounded-lg border border-dashed border-neutral-700 ${pad}`}>
                    ...
                    {/* Inline header stand-in — the real PageHeader is out of scope for this tokens-only
                        branch; the eyebrow → title gap uses DSCOMMON_EYEBROW_TO_TITLE. */}
                    <div className={`flex flex-col ${DSCOMMON_EYEBROW_TO_TITLE.className ?? ''}`}>
                        <span className="text-xs font-medium uppercase tracking-wide text-outer-space-300">
                            Details
                        </span>
                        <h1 className="m-0 text-2xl font-medium text-white">Page title</h1>
                    </div>
