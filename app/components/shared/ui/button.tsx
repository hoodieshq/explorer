...
const buttonVariants = cva(
    cn(
        ...
        'e-transition-colors',
        'focus-visible:e-outline-none focus-visible:e-ring-1 focus-visible:e-ring-neutral-950',
    ...
    ),
    {
        ...
        variants: {
            ...
            variant: {
                ...
                destructive: 'e-border-0 e-bg-destructive e-text-neutral-50 e-shadow-sm hover:e-bg-destructive/90',
                ghost: 'hover:e-bg-neutral-100 hover:e-text-neutral-900',
                link: 'e-text-neutral-900 e-underline-offset-4 hover:e-underline',
                outline:
                    'e-border e-border-neutral-600 e-bg-transparent e-text-white hover:e-bg-neutral-600/10 focus-visible:e-ring-1 focus-visible:e-ring-neutral-950',
