...
export function PopoverButton({
    ...
    return (
        <Popover>
            ...
            {/* The panel keeps a 6px inset to its border while the rows inside carry 4px of their own,
                and the 4px gap sets what the hover highlights need to read as separate rows at every
                width. The radius is PopoverContent's own `rounded-md`, left untouched. */}
            <PopoverContent
                align={align}
