import * as anchorModule from '@entities/idl/model/use-anchor-program';
import * as programMetadataEntity from '@entities/program-metadata';
...
describe('IdlCard', () => {
    ...
    test.skip('should render IdlCard with PMP IDL when programMetadataIdl exists', async () => {
        ...
        vi.spyOn(programMetadataEntity, 'useProgramMetadataIdl').mockReturnValue({
