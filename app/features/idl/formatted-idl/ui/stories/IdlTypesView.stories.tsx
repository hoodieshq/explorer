...
import { IdlTypesView } from '../IdlTypesView';
...
const meta = {
    ...
    tags: ['autodocs', 'test'],
    title: 'Features/IDL/Formatted IDL/UI/IdlTypesView',
...
export const LongEnumVariant: Story = {
    args: {
        data: [
            {
                docs: ['PermissionMessage'],
                fieldType: {
                    kind: 'enum',
                    variants: [
                        'V1 {"nonce":"u64","consumerProgram":"pubkey","permissionSigner":"PermissionSigner","permissionSubject":"pubkey","validUntil":"u64","permissionType":"u8","instructionDiscriminators":"vec(bytes)"}',
                    ],
                },
