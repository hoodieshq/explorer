...
const meta = {
    component: IdlDocView,
    tags: ['autodocs', 'test'],
    title: 'Features/IDL/Formatted IDL/UI/IdlDocView',
} satisfies Meta<typeof IdlDocView>;
...
// Create a separate meta for IdlDocViewTooltip
const tooltipMeta = {
    ...
    tags: ['autodocs', 'test'],
    title: 'Components/Account/idl/components/IdlDocViewTooltip',
